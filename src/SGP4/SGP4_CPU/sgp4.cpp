...
void sgp4(gravconstant_t gravity_constants, satelliterecord_soa_t *satrec, int tid, double tsince, float4 *r)
{
...
void ComputeSGP4(	float4 *positions, double deltatime, int numberSatellites	){	
